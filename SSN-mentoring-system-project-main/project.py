...
def login(myframe):   
    ...
    #    mb2.grid(row=1,column=3,padx=10,pady=10)
        hg=Button(myframe,text="BACK",fg='white',bg='#A2ACBE',font=('Helvetica',12),command=lambda :openx(myframe)).place(relx=0.5,rely=1)
    else:
        messagebox.showinfo("","Invalid Username or Password")
